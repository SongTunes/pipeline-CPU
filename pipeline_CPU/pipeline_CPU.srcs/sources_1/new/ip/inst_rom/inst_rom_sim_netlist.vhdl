...
--               D:/git-project/pipeline-CPU-1/pipeline_CPU/pipeline_CPU.srcs/sources_1/new/ip/inst_rom/inst_rom_sim_netlist.vhdl
-- Design      : inst_rom
...
begin
  ...
  qspo(0) <= \<const0>\;
  spo(31) <= \^spo\(24);
  spo(30 downto 26) <= \^spo\(30 downto 26);
  spo(25) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.inst_rom_dist_mem_gen_v8_0_13_synth
     port map (
      a(9 downto 0) => a(9 downto 0),
      spo(28) => \^spo\(24),
      spo(27 downto 23) => \^spo\(30 downto 26),
      spo(22 downto 20) => \^spo\(23 downto 21),
      spo(19 downto 0) => \^spo\(19 downto 0)
    );
end STRUCTURE;
library IEEE;
